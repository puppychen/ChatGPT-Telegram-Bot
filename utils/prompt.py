...
translator_en2zh_prompt = (
    "你是一位精通繁體中文的專業翻譯，尤其擅长将专业学术论文翻译成浅显易懂的科普文章。请你帮我将以下英文段落翻译成中文，风格与中文科普读物相似。"
    "规则："
    "- 翻译时要准确传达原文的事实和背景。"
...
system_prompt = (
    "You are a large language model trained. Respond conversationally in {}. Knowledge cutoff: 2023-04. Current date: [ {} ]. Please reply in Traditional Chinese"
